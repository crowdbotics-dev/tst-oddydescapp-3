"""
Django settings for tst_oddydescapp_3 project.
...
ROOT_URLCONF = 'tst_oddydescapp_3.urls'
...
WSGI_APPLICATION = 'tst_oddydescapp_3.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "tst-oddydescapp Support <support@tst-oddydescapp-3.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_oddydescapp_3 API",
    "DESCRIPTION": "API documentation for tst_oddydescapp_3 App",
    "VERSION": "v1",
}
